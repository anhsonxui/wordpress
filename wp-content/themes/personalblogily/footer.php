		...
		<?php if ( get_theme_mod( 'footer_copyright_control' ) == '' ) : ?>
			<div class="site-info">
				...
				<span class="footer-info-right">
					<?php echo esc_html_e(' |', 'personalblogily') ?> <?php echo esc_html_e('Powered by Superbs ', 'personalblogily') ?> <a rel="nofollow" href="https://superbthemes.com/personalblogily/"><?php echo esc_html_e('Personal Blog theme', 'personalblogily') ?></a> 
